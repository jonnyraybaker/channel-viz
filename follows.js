(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'UNlTns1Yd5nPeXNYk1Xq3zNlpP0Du2stvtL0WSq5QaJ5asS7', // Unique master Xively API key to be used as a default
		...
		dataDuration	= '6', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 500, // Default interval for data to be displayed (in seconds)
